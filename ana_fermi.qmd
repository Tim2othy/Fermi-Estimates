...
norm_results[11, 1] <- "Total_normalized_error"
...
plot(c(1:10), norm_results[11, 2:11])
# now as a barchart
barplot(norm_results[11, 2:11], names.arg = names(norm_results)[2:11], col = "lightblue", main = "Normalized errors", ylab = "Normalized error", xlab = "Person and type of estimate")
...
barplot(
    ...
    col = "lightblue",
    main = "Normalized Errors",
    ylab = "Normalized Error",
    xlab = "Person and Type of Estimate"
)
```